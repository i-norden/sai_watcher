...
func (blockRepository BlockRepository) GetInt(result *int64, cmd string, args ...interface{}) error {
	return blockRepository.database.Get(result, cmd, args)
}

func (blockRepository BlockRepository) Exec(cmd string, args ...interface{}) (sql.Result, error) {
	return blockRepository.database.Exec(cmd, args)
}
